...
<div class="flex flex-col items-center justify-center">
	...
	<div class="flex h-screen items-center justify-center">
		<div class="flex h-min flex-row items-center justify-center divide-x-2">
			<ul class="pr-3 text-right text-4xl font-bold text-dark-blue">
				<li>
					<h1>Aaron</h1>
				</li>
				<li>
	...
	<div class="flex h-screen flex-col items-center justify-center" id="about">
		<ul role="list" class="divide-y mx-2">
				...
				<div class="flex min-w-0 gap-x-2">
					<div class="min-w-0 flex-auto">
						...
						<div class="mt-4 flex items-center gap-x-2">
							...
							<a
								class="text-s truncate leading-6 text-slate-600 hover:text-blue-600 hover:decoration-blue-600"
								href="https://www.linkedin.com/in/aaron-j-oliver/"
								>linkedin.com/in/aaron-j-oliver/</a
							>
						</div>
			...
			<li class="flex justify-evenly py-5">
				<p class="leading-6 text-slate-900">
					Please view my <a
						class="underline text-dark-blue hover:text-blue-600 hover:decoration-blue-600"
