...
<header>
	<nav class="m-2 grid grid-cols-3">
		...
		<div class="flex items-center justify-end max-sm:hidden">
			<div class="flex items-center gap-2">
				<ul class="flex flex-col gap-2">
					...
					>
					<a href="https://github.com/a-j-olly">
				...
				<a href="https://linkedin.com/in/aaron-j-oliver/">
					<img class="h-16 w-16 rounded-full" src={portrait} alt="Aaron Jay Oliver" />
				</a>
			</div>
		</div>
	</nav>
