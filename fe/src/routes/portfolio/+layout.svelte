...
<header>
	<nav class="m-2 mb-4 grid grid-cols-3">
		<div
			class="flex h-min flex-row items-center justify-start divide-x-2 divide-slate-600 font-serif"
		>
			<ul class="text-dark-blue pr-2 text-right text-lg font-bold leading-5 hover:text-blue-700">
				<a href="/">
					<li>
						<h1>Aaron</h1>
					</li>
			...
			<ul
				class="pl-2 text-lg leading-5 text-slate-800 underline decoration-slate-600 hover:text-blue-600 hover:decoration-blue-600"
			>
				<li>
		...
		<div class="flex items-center justify-end max-sm:col-span-2">
			<div class="flex items-center gap-2">
				...
				<ul
					class="flex flex-col gap-2 font-serif text-slate-800 underline decoration-slate-600 hover:text-blue-600 hover:decoration-blue-600"
				>
					<li>
